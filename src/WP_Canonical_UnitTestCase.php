...
use ArtOfWP\WP\Testing\Factory\WP_UnitTest_Factory;
...
class WP_Canonical_UnitTestCase extends WP_UnitTestCase {
	 ...
	 * @return false|null|string $can_url Returns the original $test_url if no canonical can be generated, otherwise returns
